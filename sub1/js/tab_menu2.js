$(document).ready(function(){
    var cnt=$('.content_area .box').size();  //탭메뉴 개수 ***
    $('.box:eq(0)').show(); // 첫번째 탭 내용만 열어라
    ...
    $('.tab_menu .tab').click(function(e){
          ...
          //*** 이거 추가 !! (css : 전체 컨텐츠 박스에서 밑 자를 부분만 높이/overflow:hidden; 설정하기)


          $(".content_area .box").hide(); //모든 탭내용을 안보이게...
          $(".content_area .box:eq("+ind+")").show(); //클릭한 해당 탭내용만 보여라
